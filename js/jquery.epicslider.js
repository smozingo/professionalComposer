...
(function ($) {
	$.fn.epicSlider = function (options) {	
		...
		var defaults = {
			...
			slideShowInterval:9500,						//Integer: slideshow cycling speed, in milliseconds
		...
		var	slider = $(this),
			...
			/*construct nav
			-----------------------------*/
			console.log("SCHNO we are here and slideshow = " + es_options.slideShow + " and interval = " + es_options.slideShowInterval);
